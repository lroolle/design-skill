...
| [pbakaus/impeccable](https://github.com/pbakaus/impeccable) | Apache-2.0 | one skill, many commands, browser iteration, detector rules | the brand-vs-product register; PRODUCT.md / DESIGN.md context files; color strategy chosen before colors; the physical "scene sentence"; the two-altitude reflex check; automated output is evidence, not proof |
